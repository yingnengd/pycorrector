...
USER_DATA_DIR = os.path.expanduser('/datasets/')
...
pretrain_dir = "../paddle-ernie-cache"
# electra模型文件夹路径
...
# macbert模型文件路径
macbert_model_dir = os.path.join(USER_DATA_DIR, 'macbert_models/chinese_finetuned_correction/ernie_corrector')
